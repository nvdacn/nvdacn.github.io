...
BLOG_AUTHOR = "nvdacn"  # (translatable)
BLOG_TITLE = "NVDA中文站"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://nvdacn.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://nvdacn.github.io/"
BLOG_EMAIL = "dingpengyu06@gmail.com"
BLOG_DESCRIPTION = "改变，从这里开始。"  # (translatable)
